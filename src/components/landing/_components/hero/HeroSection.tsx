    ...
    >
      <div className="relative mx-auto mt-24 flex w-full max-w-7xl flex-1 flex-col items-center justify-evenly gap-6 px-6 md:mt-36 md:flex-row">
        <div className="flex flex-col">
          ...
          {/* The wordmark images are the page's main heading; their alts
              give the h1 its accessible name ("Eat donut"). */}
          <h1>
            <Image
              src={EatText}
              alt="Eat"
          ...
          <p className="my-6 hidden max-w-[440px] font-mono text-sm leading-relaxed text-background md:block">
